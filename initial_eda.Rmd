...
levels(labels$VALENCE.PLEASANTNESS) <- list("Unpleasent" = c(0:34), "Neutral" = c(34:67), "Pleasant" = c(67:100))

labels$INTENSITY.STRENGTH <- factor(labels$INTENSITY.STRENGTH)
levels(labels$INTENSITY.STRENGTH) <- list("Low" = c(0:34), "Medium" = c(34:67), "High" = c(67:100))
